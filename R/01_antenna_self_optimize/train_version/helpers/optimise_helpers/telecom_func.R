...
##
# Compute gain after having moved horizontal and vertical angle 计算天馈增益
##

funcgain = function(delta_azimuth, delta_tilt, azimuth_3db, tilt_3db, gain_antenna) {
  # delta_azimuth：终端用户与天馈之间的水平夹角 delta_tilt：终端用户与天馈之间的垂直夹角
  # azimuth_3db：3db方位角 tilt_3db：dB下倾角 gain_antenna： 天馈固定增益
